...
# %%
def test1():
    pulse = context.init_pulselib(n_gates=3, n_sensors=1, virtual_gates=True)
    context.virtual_matrix[2, 0] = 0.0
    context.virtual_matrix[0, 2] = 0.0
    context.virtual_matrix[2, 1] = 0.0
    context.virtual_matrix[1, 2] = 0.0
    ...
    # This once triggered a bug after recompile, because this gate has no elements in matrix
    s.P3.add_block(0, 10, 100)
    s.reset_time()
